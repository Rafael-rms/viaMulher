...
export default function Pergunta13({ navigation }) {
    ...
    async function pegarResposta(){
        ...
        await updateDoc(doc(db, "formulario", dadosUsuario.id),{resposta13})
        navigation.navigate('Pergunta14')
        }
        ...
        <ScrollView contentContainerStyle={{flex:1}}>
            <View style={styles.container}>
                ...
                <Text style={styles.textData}>Data de Preenchimento: {dia}</Text>
                    <Text style={[styles.textUsuario, { marginLeft: '70%' }]}>13/19</Text>
                </>
                ...
                <View >
                    ...
                    <Botao onPress={() => {setResposta13("Sim")}} texto="Sim"></Botao>
                    <Botao onPress={() => {setResposta13("Não")}} texto="Não"></Botao>
                    <Botao onPress={() => {setResposta13("Não sabe")}} texto="Não sabe"></Botao>
                    <Botao onPress={() => {setResposta13("Não se aplica")}} texto="Não se aplica"></Botao>
