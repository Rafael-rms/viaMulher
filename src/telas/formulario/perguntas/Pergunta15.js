    ...
    return (
        <ScrollView>
            <View style={styles.container}>
                ...
                <Caixa 
                texto="O(A) agressor(a) faz uso de medicação controlada para alguma doença mental/psiquiátrica?"/>

                <View>
                    {/* Botões do formulário */}
                    <Botao onPress={() => {setResposta15("Sim")}} texto="Sim"></Botao>
                    <Botao onPress={() => {setResposta15("Não")}} texto="Não"></Botao>
                    <Botao onPress={() => {setResposta15("Não sabe")}} texto="Não sabe"></Botao>
                    <Botao onPress={() => {setResposta15("Não se aplica")}} texto="Não se aplica"></Botao>
