        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            <View style={styles.container}>
                ...
                <View>
                    ...
                    <Botao onPress={() => {setResposta11("Sim")}} texto="Sim"></Botao>
                    <Botao onPress={() => {setResposta11("Não")}} texto="Não"></Botao>
                    <Botao onPress={() => {setResposta11("Não sabe")}} texto="Não sabe"></Botao>
                    <Botao onPress={() => {setResposta11("Não se aplica")}} texto="Não se aplica"></Botao>
